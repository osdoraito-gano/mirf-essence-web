      ...
      <div className="relative bg-[#1A1A1D] border border-gold/30 rounded-2xl max-w-lg w-full shadow-gold-lg animate-slide-up overflow-hidden">
        ...
        <div className="p-8 pt-4 text-center">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-gold mt-3 mb-4">
            ¡Feliz Día<br />de las Madres!
          </h2>
          <p className="text-light/80 font-body mb-6">
            Sorprende a mamá con la esencia que merece.  
            Fragancias AAA y cilíndricas con <strong className="text-gold">descuentos especiales</strong> por lanzamiento.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href={`https://wa.me/584125592798?text=${encodeURIComponent("Hola MIRF, quiero aprovechar la promo del Día de las Madres")}`}
              target="_blank"
          ...
          <p className="text-light/40 text-xs mt-6">
            *Oferta válida hasta el 11 de mayo
          </p>
        </div>
      </div>
    </div>
