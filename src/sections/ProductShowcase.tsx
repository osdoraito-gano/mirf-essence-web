          ...
          <div ref={contentRef} className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {productShowcaseConfig.ctaText && (
                <a
                  href={productShowcaseConfig.ctaHref || '#'}
                  className="group flex items-center justify-center gap-4 px-8 py-4 bg-pink text-black font-display font-bold text-sm uppercase tracking-wider hover:bg-white transition-all duration-300"
                  data-cursor-hover
                >
              ...
              {productShowcaseConfig.whatsappCta && (
                <a
                  href={productShowcaseConfig.whatsappHref || '#'}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center gap-4 px-8 py-4 border-2 border-green-500 text-green-500 font-display font-bold text-sm uppercase tracking-wider hover:bg-green-500 hover:text-black transition-all duration-300"
                  data-cursor-hover
                >
