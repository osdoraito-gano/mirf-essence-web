        ...
        >
          {colorPaletteConfig.colors.map((swatch, index) => (
            ...
            >
              ...
              {/* Overlay info */}
              <div className="absolute inset-0 bg-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4 text-center">
                ...
                <span className="font-body text-white/60 text-xs mb-3">
                  {swatch.description}
                </span>
                <span className="font-display font-bold text-lg text-pink mb-3">
                  {swatch.price}
                </span>
                <a
                  href={swatch.whatsappLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-green-500 text-black font-display font-bold text-xs uppercase tracking-wider hover:bg-green-400 transition-all duration-300"
