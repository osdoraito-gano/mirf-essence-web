        ...
        <div className="lg:col-span-3 flex items-center px-6 lg:px-16 py-24">
          <div ref={textRef} className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {finaleConfig.whatsappCta && (
                <a
                  href={finaleConfig.whatsappHref || '#'}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-4 px-8 py-4 border-2 border-green-500 text-green-500 font-display font-bold text-sm uppercase tracking-wider hover:bg-green-500 hover:text-black transition-all duration-300"
                  data-cursor-hover
                >
